...
HD_PWD='C:/Users/KJS/VIVADO_WS/fpga_projects/cm_projects/changmin_pro_1/changmin_pro_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_shifting.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_shifting.tcl -notrace
